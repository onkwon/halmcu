...
TEST(uart_driver, init_ShouldReturnTrue_WhenAllGivenParamVaild) {
	mock().expectOneCall("pwr_ll_enable_peripheral").withParameter("peri", PERIPH_UART0);
	mock().expectOneCall("clk_ll_enable_peripheral").withParameter("peri", PERIPH_UART0);
...
TEST(uart_driver, deinit) {
	...
	mock().expectOneCall("clk_ll_disable_peripheral").withParameter("peri", PERIPH_UART0);
	mock().expectOneCall("pwr_ll_disable_peripheral").withParameter("peri", PERIPH_UART0);
...
TEST(uart_driver, rx_interrupt_ShouldCallRxHandler) {
	...
	mock().expectOneCall("uart_get_event").withParameter("port", PERIPH_UART0)
...
TEST(uart_driver, tx_interrupt_ShouldCallTxHandler) {
	...
	mock().expectOneCall("uart_get_event").withParameter("port", PERIPH_UART1)
...
TEST(uart_driver, error_interrupt_ShouldCallErrorHandler) {
	...
	mock().expectOneCall("uart_get_event").withParameter("port", PERIPH_UART2)
...
TEST(uart_driver, error_interrupt_ShouldCallNothing_WhenNohandlerRegistered) {
	...
	mock().expectOneCall("uart_get_event").withParameter("port", PERIPH_UART3)
		.andReturnValue(UART_EVENT_ERROR);
