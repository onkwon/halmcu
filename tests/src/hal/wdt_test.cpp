...
TEST(Watchdog, get_clock_freq_ShouldReturnWdtClockFreq_WhenMainSourceGiven) {
	mock().expectOneCall("wdt_ll_get_clock_source").andReturnValue(CLK_PLL);
	mock().expectOneCall("clk_ll_get_frequency").withParameter("clk", CLK_PLL)
		.andReturnValue(75000000);
	mock().expectOneCall("wdt_ll_get_prescaler").andReturnValue(64);
	LONGS_EQUAL(1171875, wdt_get_clock_frequency());
}
TEST(Watchdog, get_clock_freq_ShouldReturnWdtClockFreq_WhenIOSC16Given) {
	mock().expectOneCall("wdt_ll_get_clock_source").andReturnValue(CLK_HSI);
	mock().expectOneCall("clk_ll_get_frequency").withParameter("clk", CLK_HSI)
		.andReturnValue(16000000);
	mock().expectOneCall("wdt_ll_get_prescaler").andReturnValue(16);
	LONGS_EQUAL(1000000, wdt_get_clock_frequency());
}
TEST(Watchdog, get_clock_freq_ShouldReturnWdtClockFreq_WhenSubXtalGiven) {
	mock().expectOneCall("wdt_ll_get_clock_source").andReturnValue(CLK_LSE);
	mock().expectOneCall("clk_ll_get_frequency").withParameter("clk", CLK_LSE)
		.andReturnValue(36768);
	mock().expectOneCall("wdt_ll_get_prescaler").andReturnValue(1);
	LONGS_EQUAL(36768, wdt_get_clock_frequency());
}
TEST(Watchdog, get_clock_freq_ShouldReturnWdtClockFreq_WheniRingOSCGiven) {
	mock().expectOneCall("wdt_ll_get_clock_source").andReturnValue(CLK_LSI);
	mock().expectOneCall("clk_ll_get_frequency").withParameter("clk", CLK_LSI)
		.andReturnValue(1000000);
	mock().expectOneCall("wdt_ll_get_prescaler").andReturnValue(256);
